...
export default function GenerateAvatar() {
    ...
    const handleMint = async () => {
        ...
        setMinting(true);
        // Upload selected file via backend API if present, otherwise use generated preview URL
        let imageUri = previewUrl;
        if (uploadedFile) {
            imageUri = await uploadFile(uploadedFile);
            console.log("Uploaded file via backend API:", imageUri);
        }
        try {
