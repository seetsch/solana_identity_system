export default function Footer() {
    ...
    return (
        <footer className="fixed bottom-0 left-0 w-full z-50 py-4 text-slate-500 text-sm bg-white dark:bg-black dark:text-slate-400">
    ...
    return (
        ...
        >
            <svg
                ...
                fill="currentColor"
                viewBox="0 0 24 24"
                className="w-6 h-6 text-slate-500 dark:text-slate-400 hover:text-indigo-500 transition-colors"
            >
